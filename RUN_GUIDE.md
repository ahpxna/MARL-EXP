...
## Post-Round-10 typed chain harness

See `NEW_CHAINS_README.md` for the new B/H, R/P, A, structural, query, F3 and clone-state oracle experiments.
...
Do not open confirmatory seeds from these runners; they are development-only until the new Lean/statistical gates are frozen.
