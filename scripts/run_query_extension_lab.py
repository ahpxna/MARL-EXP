...
PROTOCOL_VERSION='query_representation_transfer_lab_v1'
...
FAMILIES=('generic','same_response_diff_info','signed_cancel','high_order_synergy','reference_shift','staleness','limited_support','nonlinear_nullspace','dynamic_interaction','overlapping_groups')
