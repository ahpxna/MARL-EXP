...
'MASTER.TYPED_CERTIFICATE_COMPLETION','FUNCTIONAL.SELECTIVE_CERTIFICATE_MAINTENANCE','SUPPORT.DECISION_CRITICAL_IDENTIFICATION','STRUCTURAL.PREFIX_COVER_DIMENSION','D6.COST_AWARE_PAEC_COMPLETION','D6.FIRST_ORDER_INSUFFICIENCY_B7','QUERY.IDENTIFIABILITY_VERIFIER',
}
...
def test_registry_covers_every_proposal_node():
    ...
    assert payload['schema'] == 'cig_amf_proposal_experiment_registry_v3'
